...
# Wrapper to find the correct python environment

# Optimize for CWD: Hooks run from repo root usually, but let's be safe.
...
echo "🤖 Auto-Doc Hook: Using Python at $SDK_PYTHON"

# Run the hook module
$SDK_PYTHON -m autodoc.hooks.post_commit
if [ $? -ne 0 ]; then
    echo "❌ Auto-Doc Hook Failed. Ensure 'autodoc' is installed in $SDK_PYTHON"
fi
"""
